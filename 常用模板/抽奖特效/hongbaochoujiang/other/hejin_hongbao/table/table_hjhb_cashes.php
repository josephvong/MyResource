...
class table_hjhb_cashes extends discuz_table{
    public function __construct() {
        $this->_table = 'hjhb_cashes';
        $this->_pk = 'id';
        parent::__construct();
    }
    ...
    public function fetch_all_aid($aid){
         return DB::fetch_all('select * from %t where aid=%d order by add_time desc',array($this->_table,$aid));
    }
    public function fetch_limit_aid($aid,$start,$count){
         return DB::fetch_all('select * from %t where aid=%d order by add_time desc limit %d,%d',array($this->_table,$aid,$start,$count));
    }
