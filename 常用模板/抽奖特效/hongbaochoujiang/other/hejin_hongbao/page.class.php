...
{ if($this -> myde_page != 1){
    return "    <li><a href=\"".$this -> page_replace(1)."\" title=\"".lang('plugin/hejin_hongbao', 'shouyephp')."\" ><span>".lang('plugin/hejin_hongbao', 'shouyephp')."</span></a></li>\n";  
   }else{
    return "    <li><span>".lang('plugin/hejin_hongbao', 'shouyephp')."</span></li>\n";  
   }
}
private function myde_prev() //上一页
{ if($this -> myde_page != 1){
    return "    <li><a href=\"".$this -> page_replace($this->myde_page-1) ."\" title=\"".lang('plugin/hejin_hongbao', 'shangyiye')."\" ><span>".lang('plugin/hejin_hongbao', 'shangyiye')."</span></a></li>\n";
   }else{
    return "    <li><span>".lang('plugin/hejin_hongbao', 'shangyiye')."</span></li>\n";  
   }
}
private function myde_next() //下一页
{
if($this -> myde_page != $this -> myde_page_count){
     return "    <li><a href=\"".$this -> page_replace($this->myde_page+1) ."\" title=\"".lang('plugin/hejin_hongbao', 'xiayiye')."\" ><span>".lang('plugin/hejin_hongbao', 'xiayiye')."</span></a></li>\n";
   }else
     {
    return "    <li><span>".lang('plugin/hejin_hongbao', 'xiayiye')."</span></li>\n";  
   }
}
private function myde_last() //尾页
{
   if($this -> myde_page != $this -> myde_page_count){
     return "    <li><a href=\"".$this -> page_replace($this -> myde_page_count)."\" title=\"".lang('plugin/hejin_hongbao', 'moye')."\" ><span>".lang('plugin/hejin_hongbao', 'moye')."</span></a></li>\n";
   }else{
     return "    <li><span>".lang('plugin/hejin_hongbao', 'moye')."</span></li>\n";  
   }
}
...
{ if($this -> myde_page != 1){
    return "    <a href=\"".$this -> page_replace(1)."\" title=\"".lang('plugin/hejin_hongbao', 'shouyephp')."\" class=\"page-first\" >".lang('plugin/hejin_hongbao', 'shouyephp')."</a>\n";  
   }
}
private function myde_prevhd() //上一页
{ if($this -> myde_page != 1){
    return "    <a href=\"".$this -> page_replace($this->myde_page-1) ."\" title=\"".lang('plugin/hejin_hongbao', 'shangyiye')."\" class=\"page-prev\">".lang('plugin/hejin_hongbao', 'shangyiye')."</a>";
   }
}
private function myde_nexthd() //下一页
{
if($this -> myde_page != $this -> myde_page_count){
     return "    <a href=\"".$this -> page_replace($this->myde_page+1) ."\" title=\"".lang('plugin/hejin_hongbao', 'xiayiye')."\" class=\"page-next\">".lang('plugin/hejin_hongbao', 'xiayiye')."</a>";
   }
}
private function myde_lasthd() //尾页
{
   if($this -> myde_page != $this -> myde_page_count){
     return "   <a href=\"".$this -> page_replace($this -> myde_page_count)."\" title=\"".lang('plugin/hejin_hongbao', 'moye')."\" class=\"page-last\">".lang('plugin/hejin_hongbao', 'moye')."</a>";
   }
}
